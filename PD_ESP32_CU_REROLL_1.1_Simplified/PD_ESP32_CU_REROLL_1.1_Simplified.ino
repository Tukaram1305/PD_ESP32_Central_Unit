...
uint8_t m2oneLEDstrip[] = {0x94, 0xB9, 0x7E, 0x14, 0x6A, 0x42};    // SPALONE {0x94, 0xB9, 0x7E, 0x14, 0x4C, 0x77}; // esp-01s - 1-LED
                                                                   // 94:B9:7E:14:4C:77 x -> nowa ESP01 ESP Board MAC Address:  94:B9:7E:14:6A:42 (jedno esp01 spalilo sie)
